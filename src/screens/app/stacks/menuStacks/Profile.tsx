...
import { FullView, StaticHeader } from "layouts";
	...
	return (
		<ScrollView>
			...
			>
				...
				>
					自己紹介：
					<ThemedText style={{ fontWeight: "400", color: "gray" }}>
						Influencer and digital creator known for her Pimtha
						Instagram account. Her photos include relaxed selfies,
						pet photos, and travel content. She has accrued 4.7
						million followers.
					</ThemedText>
				</ThemedText>
