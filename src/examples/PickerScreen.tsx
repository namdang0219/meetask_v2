...
import conversations from 'mocks/conversationMock';
import { longOptions } from 'mocks/longOptionMocks';
...
const contacts = _.map(conversations, (c, index) => ({...c, value: index, label: c.name, renderItem: renderContact}));
